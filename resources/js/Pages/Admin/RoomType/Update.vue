<template>
    <Head title="Editar Tipo de Habitación"/>
    <div class="row g-2 align-items-center mb-4">
        <div class="col">
            <h2 class="page-title text-capitalize">Actualizar Tipo de Habitación</h2>
        </div>
    ...
    <div class="row">
        <div class="card">
            <div class="card-header">Actualizar Tipo de Habitación</div>
            <div class="card-body">
